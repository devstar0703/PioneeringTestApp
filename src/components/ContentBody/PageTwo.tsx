...
const PageTwo = () => {
  ...
  const [removed_count, setRemovedCnt] = React.useState<number>(0)
  const [clicked_count, setClickedCount] = React.useState<number>(0)
  ...
  return (
    <PageTwoMain>
      <StyledButton onClick={handleOpenCTA}>Single CTA</StyledButton>
      <StyledButton onClick={handleOpenRemove}>Remove {removed_count}</StyledButton>
      <StyledButton onClick={handleOpenDelete} ref={btnRef}>
        Delete {clicked_count}
      </StyledButton>

      <CTAModal open={openCTA} handleClose={handleCloseCTA} />
      <RemoveModal
        open={openRemove}
